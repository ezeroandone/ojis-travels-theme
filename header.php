...
<!-- /site-header -->
    ...
    <!-- ── Mobile Menu — at body level, z-index:9999 set inline ── -->
    <div
        id="mobile-menu"
        role="dialog"
        aria-modal="true"
    ...
    <!-- ── Mobile Menu Close Button — separate element at z-index:10000,
         completely outside the menu div so no hit-test interference ── -->
    <button
        id="mobile-menu-close"
        type="button"
        aria-label="<?php esc_attr_e( 'Close navigation menu', 'ojis-travels-theme' ); ?>"
        style="display:none; position:fixed; top:0.6rem; right:0.75rem; z-index:10000; width:2.75rem; height:2.75rem; background:#f3f4f6; border:none; border-radius:0.75rem; cursor:pointer; align-items:center; justify-content:center; -webkit-tap-highlight-color:transparent;"
        ontouchstart=""
    >
        <span class="material-symbols-outlined" style="font-size:1.5rem; color:#1A211E; pointer-events:none;" aria-hidden="true">close</span>
    </button>
